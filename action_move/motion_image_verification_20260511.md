...
| `look_left` | `servo2=1800` from center | `movement_verify/20260511_230549_look_lr_corrected/` | `81.73%` | Passed |
| `look_right` | `servo2=1200` from center | `movement_verify/20260511_230549_look_lr_corrected/` | `80.79%` | Passed |
